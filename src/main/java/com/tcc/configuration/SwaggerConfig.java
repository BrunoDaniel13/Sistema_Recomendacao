...
public class SwaggerConfig {
	...
	@Bean
    OpenAPI springSistemaDeRecomendacaoOpenAPI() {
        return new OpenAPI()
            .info(new Info()
                .title("Projeto Sistema de Recomendação")
                .description("Projeto Sistema de Recomendação - FATEC - SBC")
                .version("v0.0.1")
                .license(new License()
                ...
                .contact(new Contact()
                    .name("Bruno Daniel")
                    .url("https://github.com/BrunoDaniel13")
                    .email("brunodanielferreira314@gmail.com")))
